...
We often make the assumption that the observations are independent and identically distributed or iid, in which case $p_\theta (y_1, y_2,..., y_n) = f_\theta (y_1)· f_\theta (y_2) \cdot \cdot\cdot\cdot f_\theta (y_n)$.
